      ...
      <div className="flex items-start justify-between gap-2 mb-2">
        <div className="min-w-0">
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            {word.isAiGenerated && (
              <span className="inline-flex items-center text-[9px] font-extrabold text-indigo-400 bg-indigo-500/10 border border-indigo-500/20 px-1 py-0.2 rounded" title="Generated by AI">
                AI
              </span>
            )}
          </div>
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <div className="flex items-center gap-2 flex-wrap">
              <h2 className="text-xl font-black text-white capitalize leading-none">{word.word}</h2>
              {word.isAiGenerated && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-bold bg-indigo-500/15 border border-indigo-500/30 text-indigo-300 animate-pulse">
